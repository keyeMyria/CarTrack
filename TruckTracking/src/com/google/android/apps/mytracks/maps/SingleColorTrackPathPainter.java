...
import com.nbzs.android.apps.trucktracking.MapOverlay.CachedLocation;
...
public class SingleColorTrackPathPainter implements TrackPathPainter {
  ...
  public SingleColorTrackPathPainter(Context context) {
    selectedTrackPaint = TrackPathUtilities.getPaint(com.nbzs.android.apps.trucktracking.R.color.red, context);
  }
